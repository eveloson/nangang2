...
#import "chulizhongViewController.h"
...
@implementation chulizhongViewController
...
-(void)AskingHandleRequest{
    ...
    NSDictionary *param = @{@"Action":@"AskingHandleOrOk",@"Id":str,@"Page":[NSString stringWithFormat:@"%i",page]};
