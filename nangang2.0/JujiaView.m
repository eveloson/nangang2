...
@interface JujiaView ()<UITableViewDelegate,UITableViewDataSource>
{
...
-(void)GetMyQuanZi{
    ...
    NSDictionary *param = @{@"Action":@"getFWNewsList",@"FWType":@"",@"Page":[NSString stringWithFormat:@"%i",page]};
