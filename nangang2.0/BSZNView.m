...
@interface BSZNView ()<UITableViewDelegate,UITableViewDataSource>
{
...
-(void)GetMyQuanZi{
    ...
    NSDictionary *param = @{@"Action":@"getNewsNoCList",@"CategoryName":@"办事指南",@"Page":[NSString stringWithFormat:@"%i",page]};
