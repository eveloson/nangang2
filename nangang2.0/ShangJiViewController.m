...
@interface ShangJiViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation ShangJiViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"政策解读一览";
    myTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0 , ScreenWidth, ScreenHeight -10) style:UITableViewStylePlain];
...
-(void)GetMyQuanZi{
    ...
    NSDictionary *param = @{@"Action":@"getNewsNoCList",@"CategoryName":@"政策解读",@"Page":[NSString stringWithFormat:@"%i",page]};
