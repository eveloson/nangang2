...
@interface DangWuViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation DangWuViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"党务居务一览";
...
-(void)GetMyQuanZi{
    ...
    NSDictionary *param = @{@"Action":@"getNewsNoCList",@"CategoryName":@"居务公开",@"Page":[NSString stringWithFormat:@"%i",page]};
